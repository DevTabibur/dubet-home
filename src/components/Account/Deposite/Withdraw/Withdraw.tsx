  ...
  return (
    <div className="border border-white/20 rounded-lg p-5 shadow-lg bg-gray-500/10">
      <div className="text-white">
        ...
        <p className="text-lg">Select payment method to top up your account:</p>
          ...
          <div className="p-5 h-full">
            <p className="text-xs leading-relaxed">
              <span className="block  text-left">
                আপনি যদি ৩ ঘন্টার মধ্যে আপনার সেলফ অ্যাকাউন্টে ডিপোজিটের টাকা না
                পান তাহলে অনুগ্রহ করে নেনদেরের প্রধান সহ আমাদের সাধারন ইমেইল
                অ্যাড্রেস <span className="italic">(Company Domain)</span> এ
                যোগাযোগ করুন পরবর্তী বিবরনে জমা করে লিখুন আপনার Player id,
                Transaction ID, Client no, Agent number, Time, date, Amount, এবং
                স্ক্রিন /স্ক্রিনশট/স্ক্রীনশট অ্যাপ থেকে নেনেরের কনফার্মেশন
                রিপোর্ট।
              </span>
              <span className="block text-left mt-2">
                If you do not receive the deposit amount in your gaming account
                within 3 hours please contact our general queries email
                transaction-bn@1xbet-team.com with next details: Player id,
